...
<html>
	...
	<head>
		...
		<script src="js/drawingView/drawingView.js"></script>
	...
	<body class="">
		...
		<div class="sidebar-nav">
			...
			<ul id="dashboard-menu" class="nav nav-list collapse in">
				<li>
					<a href="jsp/manu/project_detail.jsp">项目信息</a>
				</li>
			</ul>
			...
			<div class="container-fluid">
				<div class="row-fluid">
					...
					<div class="btn-toolbar">
						<button class="btn btn-primary" onclick="downloadExcel()"><i class="icon-print"></i>导出图纸信息 </button>
					...
					<form id ="drawing_part_form" action="exportExcel" method="post">
						<table class="table" id="table_drawing_part">
						</table>
					</form>
					</div>
					<footer>
