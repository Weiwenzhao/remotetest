...
<html><head>
		...
		<script src="js/drawingView/projectView.js"></script>
		<style type="text/css">
			#line-chart {
				height: 300px;
				width: 800px;
	...
	<body class="">
		...
		<div class="content">
			...
			<ul class="breadcrumb">
				<li>
					<a href="project_view">主页</a> <span class="divider">/</span></li>
				<li>
					<a href="project_view">项目</a> <span class="divider">/</span></li>
				<li class="active">信息</li>
			</ul>
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="btn-toolbar">
						<button class="btn btn-primary" onclick="check()"><i class="icon-save"></i>打印图纸信息</button>
