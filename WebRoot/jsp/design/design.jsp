...
<html><head>
		...
		<script src="js/drawingView/design.js"></script>
		<style type="text/css">
			#line-chart {
				height: 300px;
				width: 800px;
	...
	<body class="">
		...
		<div class="content">
			...
			<ul class="breadcrumb">
				...
				<a href='javascript:void(0)' role='button' onclick='project_his()'style="float:right"><i class='icon-exclamation-sign'></i>历史记录</a>
			</ul>
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="btn-toolbar">
						<button class="btn btn-primary" onclick="uploadDrawing()"><i class="icon-plus"></i>上传图纸</button>
						<a href="#myModal" data-toggle="modal" class="btn">删除</a>${requestScope.Message}
						<div class="btn-group">
						</div>
					</div>
					<div class="well">
